...
@IntDef({PlayState.CURRENT_STATE_NORMAL, PlayState.CURRENT_STATE_PREPARING, PlayState.CURRENT_STATE_PLAYING
        , PlayState.CURRENT_STATE_PAUSE, PlayState.CURRENT_STATE_AUTO_COMPLETE, PlayState.CURRENT_STATE_ERROR, PlayState.CURRENT_STATE_BUFFERING})
